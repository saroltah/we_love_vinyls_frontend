      ...
      setMarkets((prevMarkets) => ({
        ...
        results: prevMarkets.results.map((market) => {
          return market.id === id
            ? {
                ...market,
                members_attending_count: market.members_attending_count + 1,
    ...
    <div>
      ...
      <div className={styles.OnePost}>
        ...
        <div className={styles.Details}>
          <p>{description}</p>
          <p>
            <span className={styles.DetailsTitle}>Where?</span>{' '}
            <span>
              {' '}
          ...
          <p>
            <span className={styles.DetailsTitle}>When?</span>{' '}
            <span>
              {' '}
              {date}, {start} - {end}
            </span>
          ...
          <div>
            {is_organizer ? (
              <OverlayTrigger
                ...
                overlay={
                  <Tooltip>
                    You can not change attendance at your own market!
                  </Tooltip>
                }
              >
              ...
              <OverlayTrigger
                placement='top'
                overlay={
                  <Tooltip>You have to log in to show attendance!</Tooltip>
                }
              >
                <i className={`fa-solid fa-child ${emoji.Emoji}`}></i>
              </OverlayTrigger>
